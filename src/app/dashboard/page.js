            ...
            <div className="col-xl-8 col-md-12">
              <div className="card">
                <div className="card-header">
                  ...
                  <span className="text-muted">Get 15% Off on <a href="https://www.amcharts.com/" target="_blank">amCharts</a> licences. Use code "codedthemes" and get the discount.</span>
                ...
                <div className="card-block">
                  <div id="sales-analytics" style={{height: 400}} />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-12">
                ...
                <div className="card-block">
                  <div className="row">
                    ...
                    <div className="col-auto">
                      <label className="label label-success">+20%</label>
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-sm-8">
                      <canvas id="this-month" style={{height: 150}} />
                    </div>
                  </div>
                </div>
              </div>
              <div className="card quater-card">
                <div className="card-block">
                  ...
                  <h5>87</h5>
                  <p className="text-muted">Online Revenue<span className="f-right">80%</span></p>
                  <div className="progress"><div className="progress-bar bg-c-blue" style={{width: '80%'}} /></div>
                  <h5 className="m-t-15">68</h5>
                  <p className="text-muted">Offline Revenue<span className="f-right">50%</span></p>
                  <div className="progress"><div className="progress-bar bg-c-green" style={{width: '50%'}} /></div>
                </div>
              </div>
            </div>
            {/*  sale analytics end */}
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            <div className="d-inline-block align-middle">
                              <img src="assets/images/avatar-4.jpg" alt="user image" className="img-radius img-40 align-top m-r-15" />
                        ...
                        <tr>
                          <td>
                            ...
                            <div className="d-inline-block align-middle">
                              <img src="assets/images/avatar-5.jpg" alt="user image" className="img-radius img-40 align-top m-r-15" />
                              <div className="d-inline-block">
                        ...
                        <tr>
                          <td>
                            ...
                            <div className="d-inline-block align-middle">
                              <img src="assets/images/avatar-3.jpg" alt="user image" className="img-radius img-40 align-top m-r-15" />
                              <div className="d-inline-block">
                                <h6>William Jem</h6>
                        ...
                        <tr>
                          <td>
                            ...
                            <div className="d-inline-block align-middle">
                              <img src="assets/images/avatar-2.jpg" alt="user image" className="img-radius img-40 align-top m-r-15" />
                              <div className="d-inline-block">
                                <h6>David Jones</h6>
                                <p className="text-muted m-b-0">Developer</p>
                              </div>
            ...
            <div className="col-xl-4 col-md-12">
              <div className="card ">
                ...
                <div className="card-block">
                  ...
                  <div className="align-middle m-b-30">
                    <img src="assets/images/avatar-1.jpg" alt="user image" className="img-radius img-40 align-top m-r-15" />
                    <div className="d-inline-block">
                      <h6>David Jones</h6>
                      <p className="text-muted m-b-0">Developer</p>
                    </div>
